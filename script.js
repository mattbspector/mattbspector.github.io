...
playerArray[110] = new Array(17);
	...
	playerArray[160] = new Array(17);
	playerArray[160][0] = 0;//COMPLETIONS
	playerArray[160][1] = 0;//PASSING YARDS
	playerArray[160][2] = 0;//PASSING TOUCHDOWNS
	playerArray[160][3] = 0;//INTERCEPTIONS
	playerArray[160][4] = 382;//RUSH YARDS
	playerArray[160][5] = 2.6;//RUSHING TOUCHDOWNS
	playerArray[160][6] = 12;//RECEPTIONS
	playerArray[160][7] = 99.8;//RECEIVING YARDS
	playerArray[160][8] = 0.3;//RECEIVING TOUCHDOWNS
	playerArray[160][9] = 1.7;//FUMBLES
	playerArray[160][10] = 0;//TOTAL POINTS
	playerArray[160][11] = 0;//BASELINE 
	playerArray[160][12] = "Andre Brown";//NAME
	playerArray[160][13] = "RB"; //POSITION
	playerArray[160][14] = "texans"; //TEAM
	playerArray[160][15] = "Images/Andre-Brown.png";//PIC
	playerArray[160][16] = "andrebrown";

				playerArray[161] = new Array(17);
	playerArray[161][0] = 0;//COMPLETIONS
	playerArray[161][1] = 0;//PASSING YARDS
	playerArray[161][2] = 0;//PASSING TOUCHDOWNS
	playerArray[161][3] = 0;//INTERCEPTIONS
	playerArray[161][4] = 337;//RUSH YARDS
	playerArray[161][5] = 2.0;//RUSHING TOUCHDOWNS
	playerArray[161][6] = 6.3;//RECEPTIONS
	playerArray[161][7] = 51.3;//RECEIVING YARDS
	playerArray[161][8] = 0.2;//RECEIVING TOUCHDOWNS
	playerArray[161][9] = 0.5;//FUMBLES
	playerArray[161][10] = 0;//TOTAL POINTS
	playerArray[161][11] = 0;//BASELINE 
	playerArray[161][12] = "Khiry Robinson";//NAME
	playerArray[161][13] = "RB"; //POSITION
	playerArray[161][14] = "saints"; //TEAM
	playerArray[161][15] = "Images/Khiry-Robinson.png";//PIC
	playerArray[161][16] = "khiryrobinson";



				playerArray[162] = new Array(17);
	playerArray[162][0] = 0;//COMPLETIONS
	playerArray[162][1] = 0;//PASSING YARDS
	playerArray[162][2] = 0;//PASSING TOUCHDOWNS
	playerArray[162][3] = 0;//INTERCEPTIONS
	playerArray[162][4] = 0;//RUSH YARDS
	playerArray[162][5] = 0;//RUSHING TOUCHDOWNS
	playerArray[162][6] = 49.6;//RECEPTIONS
	playerArray[162][7] = 574;//RECEIVING YARDS
	playerArray[162][8] = 3.6;//RECEIVING TOUCHDOWNS
	playerArray[162][9] = 0.7;//FUMBLES
	playerArray[162][10] = 0;//TOTAL POINTS
	playerArray[162][11] = 0;//BASELINE 
	playerArray[162][12] = "Garrett Graham";//NAME
	playerArray[162][13] = "TE"; //POSITION
	playerArray[162][14] = "texans"; //TEAM
	playerArray[162][15] = "Images/Garrett-Graham.png";//PIC
	playerArray[162][16] = "garrettgraham";

	

				playerArray[163] = new Array(17);
	playerArray[163][0] = 0;//COMPLETIONS
	playerArray[163][1] = 0;//PASSING YARDS
	playerArray[163][2] = 0;//PASSING TOUCHDOWNS
	playerArray[163][3] = 0;//INTERCEPTIONS
	playerArray[163][4] = 0;//RUSH YARDS
	playerArray[163][5] = 0;//RUSHING TOUCHDOWNS
	playerArray[163][6] = 53.0;//RECEPTIONS
	playerArray[163][7] = 622;//RECEIVING YARDS
	playerArray[163][8] = 3.2;//RECEIVING TOUCHDOWNS
	playerArray[163][9] = 0.6;//FUMBLES
	playerArray[163][10] = 0;//TOTAL POINTS
	playerArray[163][11] = 0;//BASELINE 
	playerArray[163][12] = "Miles Austin";//NAME
	playerArray[163][13] = "WR"; //POSITION
	playerArray[163][14] = "browns"; //TEAM
	playerArray[163][15] = "Images/Miles-Austin.png";//PIC
	playerArray[163][16] = "milesaustin";


				playerArray[164] = new Array(17);
	playerArray[164][0] = 0;//COMPLETIONS
	playerArray[164][1] = 0;//PASSING YARDS
	playerArray[164][2] = 0;//PASSING TOUCHDOWNS
	playerArray[164][3] = 0;//INTERCEPTIONS
	playerArray[164][4] = 409;//RUSH YARDS
	playerArray[164][5] = 1.3;//RUSHING TOUCHDOWNS
	playerArray[164][6] = 3.2;//RECEPTIONS
	playerArray[164][7] = 25.7;//RECEIVING YARDS
	playerArray[164][8] = 0.2;//RECEIVING TOUCHDOWNS
	playerArray[164][9] = 1.4;//FUMBLES
	playerArray[164][10] = 0;//TOTAL POINTS
	playerArray[164][11] = 0;//BASELINE 
	playerArray[164][12] = "LeGarrette Blount";//NAME
	playerArray[164][13] = "RB"; //POSITION
	playerArray[164][14] = "steelers"; //TEAM
	playerArray[164][15] = "Images/Legarrette-Blount.png";//PIC
	playerArray[164][16] = "legarretteblount";


				playerArray[165] = new Array(17);
	playerArray[165][0] = 0;//COMPLETIONS
	playerArray[165][1] = 0;//PASSING YARDS
	playerArray[165][2] = 0;//PASSING TOUCHDOWNS
	playerArray[165][3] = 0;//INTERCEPTIONS
	playerArray[165][4] = 591;//RUSH YARDS
	playerArray[165][5] = 3.3;//RUSHING TOUCHDOWNS
	playerArray[165][6] = 26.4;//RECEPTIONS
	playerArray[165][7] = 216;//RECEIVING YARDS
	playerArray[165][8] = 1;//RECEIVING TOUCHDOWNS
	playerArray[165][9] = 1.7;//FUMBLES
	playerArray[165][10] = 0;//TOTAL POINTS
	playerArray[165][11] = 0;//BASELINE 
	playerArray[165][12] = "Mark Ingram";//NAME
	playerArray[165][13] = "RB"; //POSITION
	playerArray[165][14] = "saints"; //TEAM
	playerArray[165][15] = "Images/Mark-Ingram.png";//PIC
	playerArray[165][16] = "markingram";


				playerArray[166] = new Array(17);
	playerArray[166][0] = 319;//COMPLETIONS
	playerArray[166][1] = 3909;//PASSING YARDS
	playerArray[166][2] = 23.2;//PASSING TOUCHDOWNS
	playerArray[166][3] = 14.6;//INTERCEPTIONS
	playerArray[166][4] = 106;//RUSH YARDS
	playerArray[166][5] = 1.1;//RUSHING TOUCHDOWNS
	playerArray[166][6] = 0;//RECEPTIONS
	playerArray[166][7] = 0;//RECEIVING YARDS
	playerArray[166][8] = 0;//RECEIVING TOUCHDOWNS
	playerArray[166][9] = 7.7;//FUMBLES
	playerArray[166][10] = 0;//TOTAL POINTS
	playerArray[166][11] = 0;//BASELINE 
	playerArray[166][12] = "Joe Flacco";//NAME
	playerArray[166][13] = "QB"; //POSITION
	playerArray[166][14] = "ravens"; //TEAM
	playerArray[166][15] = "Images/Joe-Flacco.png";//PIC
	playerArray[166][16] = "joeflacco";


				playerArray[167] = new Array(17);
	playerArray[167][0] = 0;//COMPLETIONS
	playerArray[167][1] = 0;//PASSING YARDS
	playerArray[167][2] = 0;//PASSING TOUCHDOWNS
	playerArray[167][3] = 0;//INTERCEPTIONS
	playerArray[167][4] = 24.8;//RUSH YARDS
	playerArray[167][5] = 0.1;//RUSHING TOUCHDOWNS
	playerArray[167][6] = 65.2;//RECEPTIONS
	playerArray[167][7] = 702;//RECEIVING YARDS
	playerArray[167][8] = 3.3;//RECEIVING TOUCHDOWNS
	playerArray[167][9] = 1.1;//FUMBLES
	playerArray[167][10] = 0;//TOTAL POINTS
	playerArray[167][11] = 0;//BASELINE 
	playerArray[167][12] = "Andrew Hawkins";//NAME
	playerArray[167][13] = "WR"; //POSITION
	playerArray[167][14] = "browns"; //TEAM
	playerArray[167][15] = "Images/Andrew-Hawkins.png";//PIC
	playerArray[167][16] = "andrewhawkins";


				playerArray[168] = new Array(17);
	playerArray[168][0] = 0;//COMPLETIONS
	playerArray[168][1] = 0;//PASSING YARDS
	playerArray[168][2] = 0;//PASSING TOUCHDOWNS
	playerArray[168][3] = 0;//INTERCEPTIONS
	playerArray[168][4] = 13.6;//RUSH YARDS
	playerArray[168][5] = 0;//RUSHING TOUCHDOWNS
	playerArray[168][6] = 49;//RECEPTIONS
	playerArray[168][7] = 722;//RECEIVING YARDS
	playerArray[168][8] = 3.9;//RECEIVING TOUCHDOWNS
	playerArray[168][9] = 0.7;//FUMBLES
	playerArray[168][10] = 0;//TOTAL POINTS
	playerArray[168][11] = 0;//BASELINE 
	playerArray[168][12] = "Robert Woods";//NAME
	playerArray[168][13] = "WR"; //POSITION
	playerArray[168][14] = "bills"; //TEAM
	playerArray[168][15] = "Images/Robert-Woods.png";//PIC
	playerArray[168][16] = "robertwoods";


				playerArray[169] = new Array(17);
	playerArray[169][0] = 343;//COMPLETIONS
	playerArray[169][1] = 3911;//PASSING YARDS
	playerArray[169][2] = 23.1;//PASSING TOUCHDOWNS
	playerArray[169][3] = 10.4;//INTERCEPTIONS
	playerArray[169][4] = 351;//RUSH YARDS
	playerArray[169][5] = 0.9;//RUSHING TOUCHDOWNS
	playerArray[169][6] = 0;//RECEPTIONS
	playerArray[169][7] = 0;//RECEIVING YARDS
	playerArray[169][8] = 0;//RECEIVING TOUCHDOWNS
	playerArray[169][9] = 7.5;//FUMBLES
	playerArray[169][10] = 0;//TOTAL POINTS
	playerArray[169][11] = 0;//BASELINE 
	playerArray[169][12] = "Alex Smith";//NAME
	playerArray[169][13] = "QB"; //POSITION
	playerArray[169][14] = "fortyniners"; //TEAM
	playerArray[169][15] = "Images/Alex-Smith.png";//PIC
	playerArray[169][16] = "alexsmith";


				playerArray[170] = new Array(17);
	playerArray[170][0] = 0;//COMPLETIONS
	playerArray[170][1] = 0;//PASSING YARDS
	playerArray[170][2] = 0;//PASSING TOUCHDOWNS
	playerArray[170][3] = 0;//INTERCEPTIONS
	playerArray[170][4] = 306;//RUSH YARDS
	playerArray[170][5] = 1.9;//RUSHING TOUCHDOWNS
	playerArray[170][6] = 9.5;//RECEPTIONS
	playerArray[170][7] = 77.4;//RECEIVING YARDS
	playerArray[170][8] = 0.3;//RECEIVING TOUCHDOWNS
	playerArray[170][9] = 0.9;//FUMBLES
	playerArray[170][10] = 0;//TOTAL POINTS
	playerArray[170][11] = 0;//BASELINE 
	playerArray[170][12] = "James Starks";//NAME
	playerArray[170][13] = "RB"; //POSITION
	playerArray[170][14] = "packers"; //TEAM
	playerArray[170][15] = "Images/James-Starks.png";//PIC
	playerArray[170][16] = "jamesstarks";


				playerArray[171] = new Array(17);
	playerArray[171][0] = 0;//COMPLETIONS
	playerArray[171][1] = 0;//PASSING YARDS
	playerArray[171][2] = 0;//PASSING TOUCHDOWNS
	playerArray[171][3] = 0;//INTERCEPTIONS
	playerArray[171][4] = 0;//RUSH YARDS
	playerArray[171][5] = 0;//RUSHING TOUCHDOWNS
	playerArray[171][6] = 22;//RECEPTIONS
	playerArray[171][7] = 293;//RECEIVING YARDS
	playerArray[171][8] = 1.7;//RECEIVING TOUCHDOWNS
	playerArray[171][9] = 0.3;//FUMBLES
	playerArray[171][10] = 0;//TOTAL POINTS
	playerArray[171][11] = 0;//BASELINE 
	playerArray[171][12] = "Brandon LaFell";//NAME
	playerArray[171][13] = "WR"; //POSITION
	playerArray[171][14] = "patriots"; //TEAM
	playerArray[171][15] = "Images/Brandon-Lafell.png";//PIC
	playerArray[171][16] = "brandonlafell";



				playerArray[172] = new Array(17);
	playerArray[172][0] = 0;//COMPLETIONS
	playerArray[172][1] = 0;//PASSING YARDS
	playerArray[172][2] = 0;//PASSING TOUCHDOWNS
	playerArray[172][3] = 0;//INTERCEPTIONS
	playerArray[172][4] = 0;//RUSH YARDS
	playerArray[172][5] = 0;//RUSHING TOUCHDOWNS
	playerArray[172][6] = 35.8;//RECEPTIONS
	playerArray[172][7] = 442;//RECEIVING YARDS
	playerArray[172][8] = 3.5;//RECEIVING TOUCHDOWNS
	playerArray[172][9] = 0.6;//FUMBLES
	playerArray[172][10] = 0;//TOTAL POINTS
	playerArray[172][11] = 0;//BASELINE 
	playerArray[172][12] = "Stevie Johnson";//NAME
	playerArray[172][13] = "WR"; //POSITION
	playerArray[172][14] = "fortyniners"; //TEAM
	playerArray[172][15] = "Images/Stevie-Johnson.png";//PIC
	playerArray[172][16] = "steviejohnson";


				playerArray[173] = new Array(17);
	playerArray[173][0] = 0;//COMPLETIONS
	playerArray[173][1] = 0;//PASSING YARDS
	playerArray[173][2] = 0;//PASSING TOUCHDOWNS
	playerArray[173][3] = 0;//INTERCEPTIONS
	playerArray[173][4] = 289;//RUSH YARDS
	playerArray[173][5] = 2.4;//RUSHING TOUCHDOWNS
	playerArray[173][6] = 3.4;//RECEPTIONS
	playerArray[173][7] = 27.9;//RECEIVING YARDS
	playerArray[173][8] = 0.1;//RECEIVING TOUCHDOWNS
	playerArray[173][9] = 1.0;//FUMBLES
	playerArray[173][10] = 0;//TOTAL POINTS
	playerArray[173][11] = 0;//BASELINE 
	playerArray[173][12] = "Andre Williams";//NAME
	playerArray[173][13] = "RB"; //POSITION
	playerArray[173][14] = "giants"; //TEAM
	playerArray[173][15] = "Images/Andre-Williams.png";//PIC
	playerArray[173][16] = "andrewilliams";

				playerArray[174] = new Array(17);
	playerArray[174][0] = 0;//COMPLETIONS
	playerArray[174][1] = 0;//PASSING YARDS
	playerArray[174][2] = 0;//PASSING TOUCHDOWNS
	playerArray[174][3] = 0;//INTERCEPTIONS
	playerArray[174][4] = 286;//RUSH YARDS
	playerArray[174][5] = 1.6;//RUSHING TOUCHDOWNS
	playerArray[174][6] = 14.3;//RECEPTIONS
	playerArray[174][7] = 117;//RECEIVING YARDS
	playerArray[174][8] = 0.4;//RECEIVING TOUCHDOWNS
	playerArray[174][9] = 1.1;//FUMBLES
	playerArray[174][10] = 0;//TOTAL POINTS
	playerArray[174][11] = 0;//BASELINE 
	playerArray[174][12] = "Lance Dunbar";//NAME
	playerArray[174][13] = "RB"; //POSITION
	playerArray[174][14] = "cowboys"; //TEAM
	playerArray[174][15] = "Images/Lance-Dunbar.png";//PIC
	playerArray[174][16] = "lancedunbar";


				playerArray[175] = new Array(17);
	playerArray[175][0] = 0;//COMPLETIONS
	playerArray[175][1] = 0;//PASSING YARDS
	playerArray[175][2] = 0;//PASSING TOUCHDOWNS
	playerArray[175][3] = 0;//INTERCEPTIONS
	playerArray[175][4] = 0;//RUSH YARDS
	playerArray[175][5] = 0;//RUSHING TOUCHDOWNS
	playerArray[175][6] = 21.8;//RECEPTIONS
	playerArray[175][7] = 267;//RECEIVING YARDS
	playerArray[175][8] = 1.3;//RECEIVING TOUCHDOWNS
	playerArray[175][9] = 0.2;//FUMBLES
	playerArray[175][10] = 0;//TOTAL POINTS
	playerArray[175][11] = 0;//BASELINE 
	playerArray[175][12] = "Tim Wright";//NAME
	playerArray[175][13] = "TE"; //POSITION
	playerArray[175][14] = "buccaneers"; //TEAM
	playerArray[175][15] = "Images/Tim-Wright.png";//PIC
	playerArray[175][16] = "timwright";


				playerArray[176] = new Array(17);
	playerArray[176][0] = 0;//COMPLETIONS
	playerArray[176][1] = 0;//PASSING YARDS
	playerArray[176][2] = 0;//PASSING TOUCHDOWNS
	playerArray[176][3] = 0;//INTERCEPTIONS
	playerArray[176][4] = 0;//RUSH YARDS
	playerArray[176][5] = 0;//RUSHING TOUCHDOWNS
	playerArray[176][6] = 44;//RECEPTIONS
	playerArray[176][7] = 530;//RECEIVING YARDS
	playerArray[176][8] = 4.3;//RECEIVING TOUCHDOWNS
	playerArray[176][9] = 0.6;//FUMBLES
	playerArray[176][10] = 0;//TOTAL POINTS
	playerArray[176][11] = 0;//BASELINE 
	playerArray[176][12] = "Coby Fleener";//NAME
	playerArray[176][13] = "TE"; //POSITION
	playerArray[176][14] = "colts"; //TEAM
	playerArray[176][15] = "Images/Coby-Fleener.png";//PIC
	playerArray[176][16] = "cobyfleener";


				playerArray[177] = new Array(17);
	playerArray[177][0] = 0;//COMPLETIONS
	playerArray[177][1] = 0;//PASSING YARDS
	playerArray[177][2] = 0;//PASSING TOUCHDOWNS
	playerArray[177][3] = 0;//INTERCEPTIONS
	playerArray[177][4] = 0;//RUSH YARDS
	playerArray[177][5] = 0;//RUSHING TOUCHDOWNS
	playerArray[177][6] = 43.1;//RECEPTIONS
	playerArray[177][7] = 568;//RECEIVING YARDS
	playerArray[177][8] = 3.7;//RECEIVING TOUCHDOWNS
	playerArray[177][9] = 0.8;//FUMBLES
	playerArray[177][10] = 0;//TOTAL POINTS
	playerArray[177][11] = 0;//BASELINE 
	playerArray[177][12] = "Mike Williams";//NAME
	playerArray[177][13] = "WR"; //POSITION
	playerArray[177][14] = "buccaneers"; //TEAM
	playerArray[177][15] = "Images/Mike-Williams.png";//PIC
	playerArray[177][16] = "mikewilliams";



				playerArray[178] = new Array(17);
	playerArray[178][0] = 284;//COMPLETIONS
	playerArray[178][1] = 3346;//PASSING YARDS
	playerArray[178][2] = 17;//PASSING TOUCHDOWNS
	playerArray[178][3] = 16.3;//INTERCEPTIONS
	playerArray[178][4] = 368;//RUSH YARDS
	playerArray[178][5] = 3.8;//RUSHING TOUCHDOWNS
	playerArray[178][6] = 0;//RECEPTIONS
	playerArray[178][7] = 0;//RECEIVING YARDS
	playerArray[178][8] = 0;//RECEIVING TOUCHDOWNS
	playerArray[178][9] = 8.2;//FUMBLES
	playerArray[178][10] = 0;//TOTAL POINTS
	playerArray[178][11] = 0;//BASELINE 
	playerArray[178][12] = "Geno Smith";//NAME
	playerArray[178][13] = "QB"; //POSITION
	playerArray[178][14] = "jets"; //TEAM
	playerArray[178][15] = "Images/Geno-Smith.png";//PIC
	playerArray[178][16] = "genosmith";



				playerArray[179] = new Array(17);
	playerArray[179][0] = 0;//COMPLETIONS
	playerArray[179][1] = 0;//PASSING YARDS
	playerArray[179][2] = 0;//PASSING TOUCHDOWNS
	playerArray[179][3] = 0;//INTERCEPTIONS
	playerArray[179][4] = 0;//RUSH YARDS
	playerArray[179][5] = 0;//RUSHING TOUCHDOWNS
	playerArray[179][6] = 38.5;//RECEPTIONS
	playerArray[179][7] = 431;//RECEIVING YARDS
	playerArray[179][8] = 2.8;//RECEIVING TOUCHDOWNS
	playerArray[179][9] = 0.5;//FUMBLES
	playerArray[179][10] = 0;//TOTAL POINTS
	playerArray[179][11] = 0;//BASELINE 
	playerArray[179][12] = "Dwayne Allen";//NAME
	playerArray[179][13] = "TE"; //POSITION
	playerArray[179][14] = "colts"; //TEAM
	playerArray[179][15] = "Images/Dwayne-Allen.png";//PIC
	playerArray[179][16] = "dwayneallen";
				playerArray[180] = new Array(17);
	playerArray[180][0] = 0;//COMPLETIONS
	playerArray[180][1] = 0;//PASSING YARDS
	playerArray[180][2] = 0;//PASSING TOUCHDOWNS
	playerArray[180][3] = 0;//INTERCEPTIONS
	playerArray[180][4] = 0;//RUSH YARDS
	playerArray[180][5] = 0;//RUSHING TOUCHDOWNS
	playerArray[180][6] = 15.9;//RECEPTIONS
	playerArray[180][7] = 175;//RECEIVING YARDS
	playerArray[180][8] = 0.9;//RECEIVING TOUCHDOWNS
	playerArray[180][9] = 0.3;//FUMBLES
	playerArray[180][10] = 0;//TOTAL POINTS
	playerArray[180][11] = 0;//BASELINE 
	playerArray[180][12] = "Nate Burleson";//NAME
	playerArray[180][13] = "WR"; //POSITION
	playerArray[180][14] = "browns"; //TEAM
	playerArray[180][15] = "Images/Nate-Burleson.png";//PIC
	playerArray[180][16] = "nateburleson";


				playerArray[181] = new Array(17);
	playerArray[181][0] = 0;//COMPLETIONS
	playerArray[181][1] = 0;//PASSING YARDS
	playerArray[181][2] = 0;//PASSING TOUCHDOWNS
	playerArray[181][3] = 0;//INTERCEPTIONS
	playerArray[181][4] = 0;//RUSH YARDS
	playerArray[181][5] = 0;//RUSHING TOUCHDOWNS
	playerArray[181][6] = 43.5;//RECEPTIONS
	playerArray[181][7] = 618;//RECEIVING YARDS
	playerArray[181][8] = 4.5;//RECEIVING TOUCHDOWNS
	playerArray[181][9] = 1.0;//FUMBLES
	playerArray[181][10] = 0;//TOTAL POINTS
	playerArray[181][11] = 0;//BASELINE 
	playerArray[181][12] = "Kenny Britt";//NAME
	playerArray[181][13] = "WR"; //POSITION
	playerArray[181][14] = "rams"; //TEAM
	playerArray[181][15] = "Images/Kenny-Britt.png";//PIC
	playerArray[181][16] = "kennybritt";

	playerArray[182] = new Array(17);
	playerArray[182][0] = 244;//PTS ALLOW
	playerArray[182][1] = 51.7;//SACK
	playerArray[182][2] = 0.1;//SAFE
	playerArray[182][3] = 19.4;//INT
	playerArray[182][4] = 10;//FUM REC
	playerArray[182][5] = 4;//TD
	playerArray[182][6] = 0.1;//BLK KICK
	playerArray[182][7] = 0;// NOTHING
	playerArray[182][8] = 0;//NOTHING
	playerArray[182][9] = 0;//NOTHING
	...
	playerArray[183] = new Array(17);
	playerArray[183][0] = 296;//PTS ALLOW
	playerArray[183][1] = 44.6;//SACK
	playerArray[183][2] = 0.1;//SAFE
	playerArray[183][3] = 19.5;//INT
	playerArray[183][4] = 9.6;//FUM REC
	playerArray[183][5] = 4;//TD
	playerArray[183][6] = 0.1;//BLK KICK
	playerArray[183][7] = 0;// NOTHING
	playerArray[183][8] = 0;//NOTHING
	playerArray[183][9] = 0;//NOTHING
	...
	playerArray[183][16] = "bengalsd";
		...
		playerArray[184] = new Array(17);
	playerArray[184][0] = 376;//PTS ALLOW
	playerArray[184][1] = 38.2;//SACK
	playerArray[184][2] = 0.6;//SAFE
	playerArray[184][3] = 16.7;//INT
	playerArray[184][4] = 12.2;//FUM REC
	playerArray[184][5] = 5;//TD
	playerArray[184][6] = 0.2;//BLK KICK
	playerArray[184][7] = 0;// NOTHING
	playerArray[184][8] = 0;//NOTHING
	playerArray[184][9] = 0;//NOTHING
	...
	playerArray[184][16] = "cardinalsd";
		...
		playerArray[185] = new Array(17);
	playerArray[185][0] = 342;//PTS ALLOW
	playerArray[185][1] = 43.8;//SACK
	playerArray[185][2] = 0.1;//SAFE
	playerArray[185][3] = 17.5;//INT
	playerArray[185][4] = 12.3;//FUM REC
	playerArray[185][5] = 3;//TD
	playerArray[185][6] = 0.1;//BLK KICK
	playerArray[185][7] = 0;// NOTHING
	playerArray[185][8] = 0;//NOTHING
	playerArray[185][9] = 0;//NOTHING
	...
	playerArray[185][16] = "patriotsd";
		...
		playerArray[186] = new Array(17);
	playerArray[186][0] = 336;//PTS ALLOW
	playerArray[186][1] = 48.7;//SACK
	playerArray[186][2] = 0.2;//SAFE
	playerArray[186][3] = 15.2;//INT
	playerArray[186][4] = 8.7;//FUM REC
	playerArray[186][5] = 2;//TD
	playerArray[186][6] = 0.2;//BLK KICK
	playerArray[186][7] = 0;// NOTHING
	playerArray[186][8] = 0;//NOTHING
	playerArray[186][9] = 0;//NOTHING
	...
	playerArray[186][16] = "broncosd";
		...
		playerArray[187] = new Array(17);
	playerArray[187][0] = 420;//PTS ALLOW
	playerArray[187][1] = 39.9;//SACK
	playerArray[187][2] = 0.1;//SAFE
	playerArray[187][3] = 14.9;//INT
	playerArray[187][4] = 9.2;//FUM REC
	playerArray[187][5] = 6;//TD
	playerArray[187][6] = 0.1;//BLK KICK
	playerArray[187][7] = 0;// NOTHING
	playerArray[187][8] = 0;//NOTHING
	playerArray[187][9] = 0;//NOTHING
	...
	playerArray[187][16] = "bearsd";
		...
		playerArray[188] = new Array(17);
	playerArray[188][0] = 394;//PTS ALLOW
	playerArray[188][1] = 42.7;//SACK
	playerArray[188][2] = 0.1;//SAFE
	playerArray[188][3] = 19.8;//INT
	playerArray[188][4] = 6.1;//FUM REC
	playerArray[188][5] = 3;//TD
	playerArray[188][6] = 0.1;//BLK KICK
	playerArray[188][7] = 0;// NOTHING
	playerArray[188][8] = 0;//NOTHING
	playerArray[188][9] = 0;//NOTHING
	...
	playerArray[188][16] = "billsd";
		...
		playerArray[189] = new Array(17);
	playerArray[189][0] = 376;//PTS ALLOW
	playerArray[189][1] = 38.2;//SACK
	playerArray[189][2] = 1.1;//SAFE
	playerArray[189][3] = 14.8;//INT
	playerArray[189][4] = 9;//FUM REC
	playerArray[189][5] = 1;//TD
	playerArray[189][6] = 0.2;//BLK KICK
	playerArray[189][7] = 0;// NOTHING
	playerArray[189][8] = 0;//NOTHING
	playerArray[189][9] = 0;//NOTHING
	...
	playerArray[189][16] = "coltsd";
		...
		playerArray[190] = new Array(17);
	playerArray[190][0] = 334;//PTS ALLOW
	playerArray[190][1] = 40.9;//SACK
	playerArray[190][2] = 0.2;//SAFE
	playerArray[190][3] = 16.6;//INT
	playerArray[190][4] = 6.1;//FUM REC
	playerArray[190][5] = 1;//TD
	playerArray[190][6] = 0.2;//BLK KICK
	playerArray[190][7] = 0;// NOTHING
	playerArray[190][8] = 0;//NOTHING
	playerArray[190][9] = 0;//NOTHING
	...
	playerArray[190][16] = "ravensd";
		...
		playerArray[191] = new Array(17);
	playerArray[191][0] = 349;//PTS ALLOW
	playerArray[191][1] = 43.4;//SACK
	playerArray[191][2] = 0.3;//SAFE
	playerArray[191][3] = 19.5;//INT
	playerArray[191][4] = 9.9;//FUM REC
	playerArray[191][5] = 3;//TD
	playerArray[191][6] = 0.1;//BLK KICK
	playerArray[191][7] = 0;// NOTHING
	playerArray[191][8] = 0;//NOTHING
	playerArray[191][9] = 0;//NOTHING
	...
	helpme.addClass("current");
		...
		$("#submit").click(function(){
			...
			var rbBase = Math.ceil(1.7625 * (RBStarter + (RBWRFlex / 2.0) + (RBWRTEFlex / 3.0)) * numteams);
			var wrBase = Math.ceil(1.275 * (WRStarter + (RBWRFlex / 2.0) + (RBWRTEFlex / 3.0)) * numteams);
